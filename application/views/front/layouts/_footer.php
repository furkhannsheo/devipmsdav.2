      ...
      <div class="row f_widgets_inner">
         <div class="col-lg-4 col-md-6 col-sm-6">
            <div class="single-footer-widget ab_widgets">
               <div class="f_title">
                  <h3>MYIPMSDA.or.id</h3>
               </div>
               <p>myIPMSDA merupakan portal informasi ikatan pelajar muhammadiyah se-sidoarjo</p>
            </div>
         </div>
         <div class="col-lg-4 col-md-6 col-sm-6">
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">myipmsda</a>
